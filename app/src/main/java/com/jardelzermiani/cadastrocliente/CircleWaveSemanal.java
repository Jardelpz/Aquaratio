 ...
 *
 */
public class CircleWaveSemanal extends View {
	...
	private int mCircleColor = Color.rgb(63,168,55);
	private int mRingColor = Color.rgb(189,238,177);
	private int mWaveColor = Color.rgb(63,168,55);
	 ...
	 * @param context
	 */
	public CircleWaveSemanal(Context context) {
		super(context);
	...
	public CircleWaveSemanal(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mContext = context;
		init(mContext);
	 ...
	 * @param defStyleAttr
	 */
	public CircleWaveSemanal(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public Parcelable onSaveInstanceState() {
		...
		com.jardelzermiani.cadastrocliente.CircleWaveDiario.SavedState ss = new com.jardelzermiani.cadastrocliente.CircleWaveDiario.SavedState(superState);
		ss.progress = (int) c;
		return ss;
	}
	...
	public void onRestoreInstanceState(Parcelable state) {
		com.jardelzermiani.cadastrocliente.CircleWaveDiario.SavedState ss = (com.jardelzermiani.cadastrocliente.CircleWaveDiario.SavedState) state;
