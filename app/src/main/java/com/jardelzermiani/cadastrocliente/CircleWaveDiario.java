 ...
 *
 */
public class CircleWaveDiario extends View {
	...
	private int mCircleColor = Color.rgb(17,143,191);
	private int mWaveColor = Color.rgb(17,143,191);
	private int mRingColor = Color.rgb(131,212,234);
	 ...
	 * @param context
	 */
	public CircleWaveDiario(Context context) {
		super(context);
	...
	public CircleWaveDiario(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mContext = context;
		init(mContext);
	 ...
	 * @param defStyleAttr
	 */
	public CircleWaveDiario(Context context, AttributeSet attrs, int defStyleAttr) {
